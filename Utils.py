...
parser.add_argument('--host', metavar='HOST', type=str, default='192.168.0.103', help='a string for a host address')
parser.add_argument('--port', metavar='PORT', type=int, default=9999, help='a integer for a port number')
parser.add_argument('--buff', metavar='BUFF', type=int, default=1, help='a buffer size for a socket connection')
